...
export default class DomOperations {
    ...
    changeToInputs(userId) {
        ...
        let cells = Array.from(row.querySelectorAll("td:not(:first-child):not(:last-child)"));
                ...
                cell.innerHTML = `
                    <select>
                        <option value="Unverified" ${
                            currentStatus === "Unverified" ? "selected" : ""
                        }>Unverified</option>
                        <option value="Verified" ${
                            currentStatus === "Verified" ? "selected" : ""
                        }>Verified</option>
                        <option value="Admin" ${
                            currentStatus === "Admin" ? "selected" : ""
                        }>Admin</option>
    ...
    clearForm() {
        this.formTitle.innerHTML =
            window.location.pathname === "/register" ? this.text.register : this.text.newUser;
